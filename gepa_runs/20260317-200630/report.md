...
| --------- | ------- | -------- | --------- | -------------- | ----------------- | -------------- | ------------- | --------------- |
| seed      | 0.0833  | 0.2500   | 0.0000    | 0.0476         | 0.2143            | 1.0000         | 0.5238        | 0.3750          |
| gepa_best | 0.0833  | 0.2500   | 0.0000    | 0.0476         | 0.2143            | 1.0000         | 0.5238        | 0.3750          |
...
- query_count: `24`
- joint_answer_or_abstain_acc: `0.1667`
- abstain_precision: `0.2143`
- abstain_recall: `1.0000`
- answer_match_rate: `0.0417`
...
| objective                      | value  |
| ------------------------------ | ------ |
| answerable_accuracy            | 0.0476 |
| abstain_precision              | 0.2143 |
| abstain_recall                 | 1.0000 |
| false_abstain_penalty          | 0.5238 |
| false_confident_answer_penalty | 0.3750 |

## Offline Slices

| slice    | count | joint_acc | pred_abstain | answer_match | evidence_hit |
| -------- | ----- | --------- | ------------ | ------------ | ------------ |
| current  | 12    | 0.0833    | 0.9167       | 0.0000       | 0.3333       |
| temporal | 12    | 0.2500    | 0.2500       | 0.0833       | 0.4167       |

## Predicted Modes

| predicted_mode | count | joint_acc | pred_abstain | answer_match | evidence_hit |
| -------------- | ----- | --------- | ------------ | ------------ | ------------ |
| current        | 15    | 0.2000    | 0.9333       | 0.0000       | 0.3333       |
| temporal       | 9     | 0.1111    | 0.0000       | 0.1111       | 0.4444       |
...
| ----------------- | ------- | -------- | --------- | -------------- | ----------------- | -------------- |
| seed_holdout      | 0.0000  | 0.1667   | 0.0000    | 0.0000         | 0.1250            | 1.0000         |
| gepa_best_holdout | 0.0000  | 0.1667   | 0.0000    | 0.0000         | 0.1250            | 1.0000         |
