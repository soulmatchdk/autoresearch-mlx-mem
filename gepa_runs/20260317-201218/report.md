...
- run_id: `20260317-201218`
- track: `temporal_selection`
- budget: `48`
- holdout_budget: `24`
- active_components: `temporal_policy, temporal_evidence_policy, answer_style_policy, answer_synthesis_policy, explanation_policy`
...
| --------- | ------- | -------- | --------- | -------------- | ----------------- | -------------- | ------------- | --------------- |
| seed      | 0.0417  | 0.2083   | 0.0000    | 0.0667         | 0.1071            | 1.0000         | 0.5556        | 0.3542          |
| gepa_best | 0.0417  | 0.2083   | 0.0000    | 0.0667         | 0.1071            | 1.0000         | 0.5556        | 0.3542          |
...
- query_count: `48`
- joint_answer_or_abstain_acc: `0.1250`
- abstain_precision: `0.1071`
- abstain_recall: `1.0000`
- answer_match_rate: `0.0625`
- answer_evidence_recall: `0.3958`

## Objectives

| objective                      | value  |
| ------------------------------ | ------ |
| answerable_accuracy            | 0.0667 |
| abstain_precision              | 0.1071 |
| abstain_recall                 | 1.0000 |
| false_abstain_penalty          | 0.5556 |
| false_confident_answer_penalty | 0.3542 |

## Offline Slices

| slice    | count | joint_acc | pred_abstain | answer_match | evidence_hit |
| -------- | ----- | --------- | ------------ | ------------ | ------------ |
| current  | 24    | 0.0417    | 0.8750       | 0.0000       | 0.3750       |
| temporal | 24    | 0.2083    | 0.2917       | 0.1250       | 0.4167       |

## Predicted Modes

| predicted_mode | count | joint_acc | pred_abstain | answer_match | evidence_hit |
| -------------- | ----- | --------- | ------------ | ------------ | ------------ |
| current        | 27    | 0.1481    | 0.9259       | 0.0370       | 0.2963       |
| multi_hop      | 4     | 0.0000    | 0.5000       | 0.0000       | 0.7500       |
| temporal       | 17    | 0.1176    | 0.0588       | 0.1176       | 0.4706       |

## Failure Buckets

| bucket                   | count |
| ------------------------ | ----- |
| attribute_mismatch       | 16    |
| entity_mismatch          | 0     |
| explanation_quality      | 0     |
| false_abstain            | 25    |
| false_confident_answer   | 22    |
| missing_evidence         | 0     |
| multi_hop_failure        | 2     |
| temporal_selection_error | 10    |
...
| ----------------- | ------- | -------- | --------- | -------------- | ----------------- | -------------- |
| seed_holdout      | 0.0000  | 0.1667   | 0.0000    | 0.0435         | 0.0625            | 1.0000         |
| gepa_best_holdout | 0.0000  | 0.1667   | 0.0000    | 0.0435         | 0.0625            | 1.0000         |
