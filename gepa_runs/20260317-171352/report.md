...
| ------------------------ | ------- | -------- | --------- | -------------- | ----------------- | -------------- | ------------- | --------------- |
| seed                     | 0.0667  | 0.1333   | 0.2667    | 0.1702         | 0.1111            | 0.0588         | 0.1702        | 0.7344          |
| temporal_recall_tune     | 0.0667  | 0.1333   | 0.2667    | 0.1702         | 0.1111            | 0.0588         | 0.1702        | 0.7344          |
| current_specificity_tune | 0.0667  | 0.1333   | 0.2667    | 0.1702         | 0.1111            | 0.0588         | 0.1702        | 0.7344          |
| multihop_balance_tune    | 0.0667  | 0.1333   | 0.2667    | 0.1702         | 0.1111            | 0.0588         | 0.1702        | 0.7344          |
...
- query_count: `64`
- joint_answer_or_abstain_acc: `0.1406`
- abstain_precision: `0.1111`
- abstain_recall: `0.0588`
- answer_match_rate: `0.1250`
- answer_evidence_recall: `0.3438`

## Objectives

| objective                      | value  |
| ------------------------------ | ------ |
| answerable_accuracy            | 0.1702 |
| abstain_precision              | 0.1111 |
| abstain_recall                 | 0.0588 |
| false_abstain_penalty          | 0.1702 |
| false_confident_answer_penalty | 0.7344 |

## Offline Slices

| slice        | count | joint_acc | pred_abstain | answer_match | evidence_hit |
| ------------ | ----- | --------- | ------------ | ------------ | ------------ |
| abstain_like | 15    | 0.0667    | 0.0667       | 0.0000       | 0.2667       |
| adversarial  | 2     | 0.0000    | 0.0000       | 0.0000       | 0.0000       |
| current      | 15    | 0.0667    | 0.1333       | 0.0667       | 0.2667       |
| historical   | 2     | 0.5000    | 0.0000       | 0.5000       | 1.0000       |
| multi_hop    | 15    | 0.2667    | 0.2000       | 0.2667       | 0.4000       |
| temporal     | 15    | 0.1333    | 0.2000       | 0.1333       | 0.4000       |

## Predicted Modes

| predicted_mode | count | joint_acc | pred_abstain | answer_match | evidence_hit |
| -------------- | ----- | --------- | ------------ | ------------ | ------------ |
| current        | 55    | 0.1455    | 0.1091       | 0.1273       | 0.3455       |
| multi_hop      | 1     | 0.0000    | 0.0000       | 0.0000       | 0.0000       |
| temporal       | 8     | 0.1250    | 0.3750       | 0.1250       | 0.3750       |

## Failure Buckets

| bucket                   | count |
| ------------------------ | ----- |
| attribute_mismatch       | 13    |
| entity_mismatch          | 0     |
| explanation_quality      | 1     |
| false_abstain            | 8     |
| false_confident_answer   | 61    |
| missing_evidence         | 0     |
| multi_hop_failure        | 1     |
| temporal_selection_error | 32    |
...
5. `locomo_conv-42_q9` | quality=`good` | abstain=`True` | pred=`ABSTAIN`
   question: When did Nate get his first two turtles?
   explanation: I abstained because the best evidence was not grounded enough to give a stable temporal answer. Top support: get, his, nate, turtles.
   support_text: Nate loves seeing his turtles eat fruit as they get excited and it's cute.
6. `locomo_conv-42_q4` | quality=`good` | abstain=`True` | pred=`ABSTAIN`
   question: When did Nate win his first video game tournament?
   explanation: I abstained because the best evidence was not grounded enough to give a stable temporal answer. Top support: first, game, his, nate.
   support_text: Nate won his first video game tournament playing Counter-Strike: Global Offensive.
7. `locomo_conv-43_q16` | quality=`weak` | abstain=`True` | pred=`ABSTAIN`
   question: Who is Anthony?
   explanation: I could not ground the question in any retrieved evidence.
8. `locomo_conv-44_q49` | quality=`good` | abstain=`True` | pred=`ABSTAIN`
...
9. `locomo_conv-42_q175` | quality=`good` | abstain=`True` | pred=`ABSTAIN`
   question: What does Nate rely on for cheer and joy?
   explanation: I abstained because the best evidence was not grounded enough to give a stable current answer. Top support: joy, nate.
   support_text: Nate mentioned his stress from tough competitors in a tournament but found joy in his turtles.
